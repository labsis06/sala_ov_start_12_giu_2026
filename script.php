...
class Com_SalaovInstallerScript
{
    ...
    private function migrate(): void
    {
        ...
        $queries = [
            "CREATE TABLE IF NOT EXISTS `#__salaov_staff` (`id` int unsigned NOT NULL AUTO_INCREMENT, `name` varchar(190) NOT NULL, `email` varchar(190) NULL, `phone` varchar(60) NULL, `spoken_language` varchar(190) NULL, `published` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DEFAULT COLLATE=utf8mb4_unicode_ci",
